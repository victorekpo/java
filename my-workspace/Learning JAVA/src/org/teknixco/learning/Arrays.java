...
public class Arrays {
	public static void main(String[] args) {
		// int value = 7; // create enough memory (32 bits) to hold an integer, value
		// type, value variable
		int[] values; // holds multiple values or list of integers, int[] is a label, reference
						// variable
		...
		// System.out.println(values[3]); // This will throw an error since it is
		// outside of the list.
