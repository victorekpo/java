...
public class DoWhile {
	public static void main(String[] args) throws IOException {
		...
		try {
			 ...
			 * System.out.println("Enter a number: "); int value = input.nextInt();
			 * 
			 * while(value !=5) { System.out.println("Enter a number: "); value =
			 * input.nextInt(); }
			 */

			// Example 2: The do while loop executes at least once, condition is checked at
			// the end.
			...
			// The code loops and doesn't reach the next line until the while loop is
			// broken.
