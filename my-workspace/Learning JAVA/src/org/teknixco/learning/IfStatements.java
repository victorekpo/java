...
public class IfStatements {
	public static void main(String[] args) {
		...
		if (myInt < 30) {
			...
			System.out.println(trueStatement);
		} else { // only use else, if you have binary conditions, that is only 2 possibilities,
					// otherwise use else if, switch statements, objects, etc. Else can also be
					// considered the final check (or everything else).
